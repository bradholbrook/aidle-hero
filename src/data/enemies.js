...
export const ENEMIES = [
  { minFloor: 1,  maxFloor: 5,   id: "slime",    name: "Slime",       icon: "🟢",
    hpMult: 0.8, hpVariance: 0.15, damageMult: 0.8,  attackSpeedMs: 1400 },
  { minFloor: 6,  maxFloor: 15,  id: "goblin",   name: "Goblin",      icon: "👺",
    hpMult: 1.0, hpVariance: 0.20, damageMult: 1.0,  attackSpeedMs: 1000 },
  { minFloor: 16, maxFloor: 30,  id: "orc",      name: "Orc Warrior", icon: "👹",
    hpMult: 1.3, hpVariance: 0.25, damageMult: 1.2,  attackSpeedMs: 1400 },
  { minFloor: 31, maxFloor: 999, id: "skeleton", name: "Skeleton",    icon: "💀",
    hpMult: 1.1, hpVariance: 0.20, damageMult: 1.1,  attackSpeedMs: 1100 },
];
